...
void plotHist() {
  ...
  const Int_t nBin = 21; //25
  //Float_t ptBins[nBin + 1] = {0., 5., 10., 15., 20., 25., 30., 32., 34., 36., 38., 40., 42., 44., 46., 48., 50., 55., 60., 70., 80., 90., 110., 130., 150., 200.};
  ...
  outEff01->Divide(reNum01, reDen01, 1., 1., "B");
